...
<g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
    ...
    <i class='bx bxs-shopping-bag-alt menu-icon'></i>
    <span class="app-brand-text demo menu-text fw-bold ms-2">ຮ້ານຂາຍເຄື່ອງ</span>
  </a>
...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item ">
    <router-link to="/pos" class="menu-link">
      <i class='bx bxs-cart menu-icon'></i>
  ...
  <li class="menu-item ">
    <router-link to="/transection" class="menu-link">
      ...
      <div data-i18n="Dashboards">ການເຄື່າອນໄຫວ</div>
    </router-link>
  </li>
